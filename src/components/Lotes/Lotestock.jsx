  ...
  return (
    <>
      ...
      <section class="bg-white dark:bg-gray-900">
        {/*fil div below  */}
        <div class="container px-6 py-8 mx-auto lg:w-[150vh] md:w-[150vh]">
            ...
            <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
              ...
              <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto h-[108%] rounded shadow-lg">
                  <img
                    class=" custom-img-2 object-cover w-full md:h-[7rem] xl:h-[7rem]shadow-x rounded"
...
<div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto h-[108%] rounded shadow-lg">
                ...
                <div class="flex flex-col items-center justify-center w-full max-w-lg mx-auto h-[108%] rounded shadow-lg">
                  <img
                    class="custom-img-2 object-cover w-full rounded-md md:h-[7rem] xl:h-[7rem]shadow-x rounded"
                    src="https://katzauction.b-cdn.net/auction_imgs/2023_03_03__170038_79P_KAPR26.jpg"
                    alt="T-Shirt"
                  />
                  <h4 class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-200">
