...
<div className="parent flex flex-row">
        ...
        <div className='flex flex-col justify-start lg:flex-col gap-16  md:mb-[170px]'>
            <div className='flex flex-col gap-8 lg:w-2/4 mx-auto m-auto'>
                <img src={activeImg} alt="" className='w-full md:h-[245px] aspect-square object-cover rounded-xl'/>
                <div className='flex flex-row justify-bcenter h-24'>
                    <img src={images.img1} alt="" className='w-[auto] h-24 rounded-md cursor-pointer mr-3' onClick={() => setActiveImage(images.img1)}/>
                    <img src={images.img2} alt="" className='w-[auto] h-24 rounded-md cursor-pointer mr-3' onClick={() => setActiveImage(images.img2)}/>
            ...
            <div className='flex flex-col gap-4 lg:w-2/4 align-middle relative left-[50px]'>
                <div>
                    <span className=' text-violet-600 font-semibold'>COIN NAME</span>
...
<h1  className=' md:mr-64 text-3xl font-bold'> Ask about the bid</h1>
<div className="relative">
  <textarea className=" mt-[36px] drop-shadow-md  border border-gray-300 p-4 rounded-lg md:w-[80vh] h-48" placeholder="Enter your message"></textarea>
  <button className="absolute bottom-2 right-2 bg-[#2e0d23] text-white font-bold py-2 px-4 rounded-lg">send message</button>
</div>
...
<div className="child-2 md:w-[100%] lg:w-[91%] bg-slate-100 md:h-[100vh] rounded-3xl drop-shadow relative right-5 ">
<div id="summary" class="w-[100%] px-8 py-10 ">
        ...
        <div className="flex flex-col  items-center">
            ...
            <button className='bg-[#2e0d23] text-white font-semibold p-[9px] w-[90&] rounded-xl h-full' >Add to cart</button>
        </div>
 <hr  className="border border-gray-950 mt-8"/>
        ...
        <div className="box bg-white  flex flex-row p-[12px] justify-center gap-[15rem]"> 
        <span className='font-[initial] text-2xl'>Current Bid</span>
        <span className='font-[initial] text-2xl'>700euro</span>

        </div>

<div className="box bg-white  flex flex-row p-[12px] justify-center gap-[15rem] mt-[4rem]"> 
        ...
        <hr  className="border border-gray-950 mt-8"/>
        <div className='flex flex-col  items-center'>
          <h1 className='class="font-[sans-serif] md:mt-[26px] md:ml-[-16rem]text-3xl  pb-8 uppercase'>place a bid</h1>
        
          <button className='bg-[#2e0d23] text-white font-semibold py-3 px-16 rounded-xl h-full'>Login or Singup</button>
        </div>
        <hr  className="border border-gray-950 mt-8"/>
