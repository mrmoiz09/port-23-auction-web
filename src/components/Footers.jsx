    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="https://flowbite.com/" class="flex items-center mb-4 sm:mb-0">
                ...
                <span class="self-center  text-white text-2xl font-semibold whitespace-nowrap ">logo</span>
            </a>
        ...
        {/* <span class="block text-[10px] text-gray-500 sm:text-center dark:text-gray-400"><a href="https://flcom/" class="hover:underline"></a> subscribe for latest auction</span> */}
